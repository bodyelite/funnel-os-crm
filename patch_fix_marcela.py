# -*- coding: utf-8 -*-
# patch_fix_marcela.py — Hotfix: refactorizar marcela() con anchors robustos
# Ejecutar desde la raiz del proyecto: python3 patch_fix_marcela.py
...
# Verificar estado: si marcelaSys ya no existe, P1 fue aplicado OK
if 'function marcelaSys(' in src:
    ...
    print('SKIP [P1 marcelaSys ya eliminada — OK]')

# P2: reemplazar marcela() completa usando anchors de inicio/fin
...
print('OK [P2 marcela() refactorizada con tRead async]')
...
src2 = open(SRV, 'r', encoding='utf-8').read()
print('marcelaSys gone :', 'function marcelaSys(' not in src2)
print('tRead(F.bot)     :', 'tRead(F.bot' in src2)
print('readFileSync gone:', 'readFileSync' not in src2)
print('\nDeploy:')
print('git add server.js && git commit -m "hotfix: marcela() tRead async — bot operativo" && git push')
