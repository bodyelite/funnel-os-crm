...
async function sendWA(to, text){
  ...
  if(!token||!phoneId){
    console.log('⚠️  WA_TOKEN/WA_PHONE_ID no configurados — mensaje no enviado a',to);
    return;
  }
  try{
    ...
    if(!res.ok) console.error('WA send error:',res.status,await res.text().catch(()=>''));
...
// ─── SEED — siempre sobrescribe leads para datos frescos de HOY ──────────────
async function seed(){
  // Usuarios
  ...
  if(!inv.demo_automotora) inv.demo_automotora=[
    ...
    {id:'AND-PG-001',brand:'Peugeot',model:'3008 PureTech 130 EAT8',year:2024,stock:4,price:18990000,fuel:'Bencina',color:'Rojo Elixir',highlights:'SUV compacto,pantalla 10"'},
    {id:'AND-PG-002',brand:'Peugeot',model:'5008 BlueHDi 130 EAT8',year:2023,stock:2,price:22490000,fuel:'Diésel',color:'Gris Artense',highlights:'7 plazas,5.5L/100km'},
    {id:'AND-KI-001',brand:'Kia',model:'Sportage 1.6 T-GDi HEV AWD',year:2024,stock:3,price:21990000,fuel:'Híbrido',color:'Snow White Pearl',highlights:'Mild 48V,AWD,180HP'},
    {id:'AND-PG-003',brand:'Peugeot',model:'408 PureTech 130 EAT8',year:2024,stock:5,price:16490000,fuel:'Bencina',color:'Negro Perla',highlights:'Fastback,8v auto'},
    {id:'AND-TY-003',brand:'Toyota',model:'Corolla 2.0 CVT GR Sport',year:2024,stock:6,price:15990000,fuel:'Bencina',color:'Rojo Supersónico',highlights:'Sport,Android Auto'},
    {id:'AND-VW-001',brand:'Volkswagen',model:'Vento 1.6 MSI Highline AT',year:2024,stock:4,price:14990000,fuel:'Bencina',color:'Plata Reflex',highlights:'Sedán ejecutivo,cuero'},
    {id:'AND-KI-002',brand:'Kia',model:'K5 2.5 MPI GT-Line AT',year:2023,stock:2,price:17990000,fuel:'Bencina',color:'Aurora Black',highlights:'Premium,crucero adaptativo'},
    {id:'AND-PG-004',brand:'Peugeot',model:'208 PureTech 100 Like AT',year:2024,stock:8,price:11490000,fuel:'Bencina',color:'Blanco Banquise',highlights:'Económico,ideal ciudad'},
    {id:'AND-PG-005',brand:'Peugeot',model:'308 PureTech 130 Allure AT',year:2024,stock:3,price:16990000,fuel:'Bencina',color:'Gris Platinium',highlights:'i-Cockpit,CarPlay'},
    {id:'AND-TY-004',brand:'Toyota',model:'Yaris 1.5 XLS CVT',year:2024,stock:7,price:11990000,fuel:'Bencina',color:'Rojo Frambuesa',highlights:'Compacto,5 años garantía'},
    {id:'AND-VW-002',brand:'Volkswagen',model:'Polo 1.6 MSI Trendline AT',year:2024,stock:5,price:12490000,fuel:'Bencina',color:'Blanco Puro',highlights:'5★ NCAP,conectividad'},
    {id:'AND-TY-005',brand:'Toyota',model:'Hilux 2.8 TDI SRX AT 4x4',year:2024,stock:3,price:32990000,fuel:'Diésel',color:'Blanco',highlights:'Cabina doble,garantía 5 años'},
    {id:'AND-TY-006',brand:'Toyota',model:'Hilux 2.8 TDI GR Sport 4x4',year:2024,stock:1,price:36990000,fuel:'Diésel',color:'Negro Metálico',highlights:'204HP,equipamiento top'},
    {id:'AND-KI-003',brand:'Kia',model:'Stonic 1.4 MPI LX AT',year:2024,stock:6,price:12990000,fuel:'Bencina',color:'Azul Stellar',highlights:'Crossover compacto,económico'},
    {id:'AND-KI-004',brand:'Kia',model:'EV6 77.4 kWh AWD GT-Line',year:2024,stock:1,price:39990000,fuel:'Eléctrico',color:'Moonscape',highlights:'530km WLTP,carga 800V'},
    {id:'AND-PG-006',brand:'Peugeot',model:'E-208 50 kWh Allure',year:2024,stock:2,price:19990000,fuel:'Eléctrico',color:'Verde Olivine',highlights:'362km,libre restricción'}
  ];
  ...
  if(!spend.demo_automotora) spend.demo_automotora={
    ...
    'WhatsApp':0,'Instagram':350000,'Landing Page':0,'Referido':0
  };
  ...
  // ── LEADS: siempre sobrescribe con timestamps de HOY (sin condición) ──────
  ...
  // Sobrescribe siempre — timestamps frescos de HOY
  leadsDB.demo_automotora = [
    // NUEVOS — SLA verde
    {id:10001,name:'Valentina Morales',phone:'+56912345678',source:'Meta Ads',
    ...
    {id:10002,name:'Ignacio Bustamante',phone:'+56976543210',source:'Google Ads',
    ...
    // NUEVO — SLA amarillo (reasignado)
    {id:10003,name:'Francisca Donoso',phone:'+56998811220',source:'Chileautos',
    ...
    // NUEVOS — SLA rojo
    {id:10004,name:'Matías Fuentes',phone:'+56966778855',source:'WhatsApp',
    ...
    {id:10005,name:'Daniela Arce',phone:'+56955449900',source:'Meta Ads',
    ...
    // CONTACTADOS
    {id:10006,name:'Roberto Cerda',phone:'+56933445566',source:'Google Ads',
     ...
     botActive:true,alertLevel:'none',intentSignal:'NONE',unread:false,reassigned:false,
    ...
    // CONTACTADO — unread, SLA risk seguimiento
    {id:10007,name:'Pamela Rojas',phone:'+56922337788',source:'Chileautos',
     ...
     botActive:true,alertLevel:'risk',intentSignal:'NONE',unread:true,reassigned:false,
     notes:[{content:'Preguntó por el seguro incluido.',author:'Rodrigo Vidal',ts:now-1200000}],
     chatHistory:[
       ...chatContactado('Peugeot 208 PureTech 100 Like AT'),
       {role:'user',content:'Oye, ¿el seguro está incluido en la cuota?',ts:now-1500000}
     ]},

    // CONTACTADO — unread, SLA critical seguimiento
    {id:10008,name:'Héctor Muñoz',phone:'+56988990011',source:'Meta Ads',
    ...
    {id:10009,name:'Catalina Espinoza',phone:'+56977114422',source:'WhatsApp',
     ...
     botActive:true,alertLevel:'none',intentSignal:'NONE',unread:false,reassigned:false,notes:[],
     chatHistory:chatContactado('Toyota Yaris 1.5 XLS CVT')},

    // CALIFICADOS
    {id:10010,name:'Juan Ignacio Pérez',phone:'+56999001122',source:'Meta Ads',
     ...
     botActive:true,alertLevel:'none',intentSignal:'BLUE',unread:false,reassigned:false,
    ...
    // CALIFICADO — unread, SLA critical seguimiento
    {id:10011,name:'María José Contreras',phone:'+56988773344',source:'Google Ads',
     ...
     botActive:true,alertLevel:'critical',intentSignal:'BLUE',unread:true,reassigned:false,
    ...
    {id:10012,name:'Felipe Soto',phone:'+56966554433',source:'Chileautos',
     ...
     botActive:true,alertLevel:'none',intentSignal:'YELLOW',unread:false,reassigned:false,
    ...
    {id:10013,name:'Andrea Vásquez',phone:'+56955667788',source:'WhatsApp',
    ...
    // CERRADOS
    {id:10014,name:'Sebastián Lagos',phone:'+56944556677',source:'Meta Ads',
    ...
    {id:10015,name:'Claudia Herrera',phone:'+56933225544',source:'Google Ads',
    ...
    {id:10016,name:'Gustavo Moreno',phone:'+56911229988',source:'Chileautos',
    ...
    // NEGOCIACIÓN — unread risk seguimiento
    {id:10017,name:'Carla Núñez',phone:'+56999112233',source:'Meta Ads',
     ...
     botActive:true,alertLevel:'risk',intentSignal:'YELLOW',unread:true,reassigned:false,
    ...
    {id:10018,name:'Tomás Araya',phone:'+56988009911',source:'Google Ads',
    ...
    // ABANDONADOS
    {id:10019,name:'Rodrigo Venegas',phone:'+56977660011',source:'Meta Ads',
    ...
    {id:10020,name:'Isabel Castillo',phone:'+56966773311',source:'Chileautos',
     ...
     chatHistory:[
       ...
       {role:'agent',content:'Hola, lamentablemente el banco no aprobó el crédito esta vez.',ts:now-39600000,agent:'vendedor1',agentName:'Rodrigo Vidal'}
     ]}
  ];

  // Recalcula alertLevel con timestamps frescos
  ...
  console.log('✅  Seed OK — leads frescos de HOY:', leadsDB.demo_automotora.length);
}
...
// Mensaje del agente → guarda + envía por WA; NO apaga el bot automáticamente
app.post('/api/leads/:id/message', auth('admin','vendedor'), async (req,res) => {
  ...
  leads[idx].chatHistory.push({
    role:'agent', content, ts:Date.now(),
    agent:req.user.username, agentName:req.user.name || req.user.username
  });
  // ✅ NO se apaga botActive — el agente puede escribir sin silenciar la IA
  leads[idx].unread          = false;
  leads[idx].lastInteraction = new Date().toISOString();
  leads[idx].alertLevel      = calcAlert(leads[idx]);
  await tWrite(F.leads, req.tenant, leads);
  ...
  if(phone) {
    sendWA(phone, content).catch(e => console.error('sendWA error:', e.message));
  }
...
// listen primero, seed después → fix Render port timeout
app.listen(PORT, () => {
  console.log(`🚀 FunnelOS en http://localhost:${PORT}`);
  console.log(`✅ Agente → WA conectado | 🤖 Bot no se apaga al responder | 📅 Seed siempre fresco`);
